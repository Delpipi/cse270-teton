...
class TestSmokeTest():
  ...
  def test_adminpageTest(self):
    ...
    self.driver.set_window_size(862, 832)
    self.driver.find_element(By.CSS_SELECTOR, "#hamburger-equiv > img").click()
    self.driver.find_element(By.LINK_TEXT, "Admin").click()
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("alex")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("12345")
    self.driver.find_element(By.CSS_SELECTOR, ".mysubmit:nth-child(4)").click()
    WebDriverWait(self.driver, 0.3).until(expected_conditions.presence_of_element_located((By.CSS_SELECTOR, ".errorMessage")))
  ...
  def test_homePageTest1(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(862, 862)
  ...
  def test_homePageTest2(self):
    ...
    WebDriverWait(self.driver, 0.3).until(expected_conditions.presence_of_element_located((By.CSS_SELECTOR, "section > h3")))
  ...
  def test_joinpageTest(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Kouame")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Alexandre Paul")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Ivonutri")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Nutrition")
